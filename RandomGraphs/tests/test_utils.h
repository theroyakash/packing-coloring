...
void printPassing() { std::cout << "\033[32m[ passed ]\033[0m" << std::endl; }
...
template <typename T>
static void assertGreaterThan(T actual, T expected,
...
template <typename T>
static void assertLessThanOrEqual(T actual, T expected,
                                  const std::string &testName) {
  std::cout << std::left << std::setw(30) << testName;
  if (actual <= expected)
    printPassing();
...
template <typename T>
static void assertGreaterThanOrEqual(T actual, T expected,
                                     const std::string &testName) {
  std::cout << std::left << std::setw(30) << testName;
  if (actual >= expected)
    printPassing();
